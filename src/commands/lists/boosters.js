            ...
            try {
                ...
                interaction.editReply({
                    embeds: [
                        new MessageEmbed()
                        .setColor("#43B581")
                        .setDescription("Voici la liste des boosters sur ce serveur.")
                        .addFields(
                            {
                                name: "`Utilisateurs`",
                                value: `>>> ${interaction.guild.members.cache.filter((m) => m.premiumSince).map((m) => `<@${m.id}> \`${m.user.tag}\``).slice(p, q).join("\n")}`,
                                inline: true
                            }
                        )
                        .setFooter({
                    ...
                    components: [
                        ...
                        .addComponents(
                            ...
                            .setDisabled(interaction.guild.members.cache.filter((m) => m.premiumSince).size > q ? false : true)
