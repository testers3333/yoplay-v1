            ...
            try {
                ...
                interaction.editReply({
                    embeds: [
                        new MessageEmbed()
                        .setColor("#43B581")
                        .setDescription("Voici la liste des administrateurs sur ce serveur.")
                        .addFields(
                            {
                                name: "`Utilisateurs`",
                                value: `>>> ${interaction.guild.members.cache.filter((m) => m.permissions.has("ADMINISTRATOR")).map((m) => `<@${m.id}> \`${m.user.tag}\``).slice(p, q).join("\n")}`,
                                inline: true
                            }
                        )
                        .setFooter({
                    ...
                    components: [
                        ...
                        .addComponents(
                            ...
                            .setDisabled(interaction.guild.members.cache.filter((m) => m.permissions.has("ADMINISTRATOR")).size > q ? false : true)
